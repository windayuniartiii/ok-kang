  ...
  <body>
   ...
   <nav class="navbar navbar-expand navbar-light fixed-top bg-white topbar mb-4 static-top shadow">
          ...
          <a class="navbar-brand" href="#">
            <img src="<?= base_url('assets/img/logo.jpeg'); ?>" width="30" height="30" class="d-inline-block align-top" alt="" loading="lazy"/>
            OKE+KANG
          </a>
            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item active">
                <a class="nav-link" href="<?= base_url('users'); ?>">Home <span class="sr-only" >(current)</span></a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="<?= base_url('paket'); ?>">Riwayat Pemesanan</a>
