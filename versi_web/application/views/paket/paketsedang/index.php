   ...
   <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-7">
         ...
         <div class="card">
          <h5 class="card-header">Form Paket Sedang</h5>
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <form method="post" action="<?= base_url('paket/paketsedang'); ?>">
                      <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                          ...
                          <input type="hidden" class="form-control" id="id_paket" name="id_paket" value="002" required>
                          <input type="hidden" class="form-control" id="id_jenis_paket" name="id_jenis_paket" value="SDG" required>
                      ...
                      <div class="form-row">
                        <div class="col-md-6 mb-3">
                          ...
                          <input type="text" class="form-control" id="jenis_paket" name="jenis_paket" value="Sedang" required readonly>
                        </div>
